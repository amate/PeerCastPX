...
static const int  PCP_CLIENT_VERSION_EX_NUMBER = 3;
static const char *PCX_AGENTEX = "PeerCast/0.1218(PX Rev.3)";
static const char *PCX_VERSTRING_EX = "v0.1218(PX Rev.3)";
#endif
